...
public class AbsoluteFieldDrive extends Command {
  ...
  public void execute() {
    ...
    poseA = new Pose2d(translation.getX(), translation.getY(), new Rotation2d(heading.getAsDouble() * Math.PI));
    poseB = new Pose2d(translation.getX(), translation.getY(), new Rotation2d(heading.getAsDouble() * Math.PI));
    publisher.set(poseA);
